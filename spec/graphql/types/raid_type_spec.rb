...
RSpec.describe Types::RaidType, type: :graphql do
  ...
  describe "#statistics" do
    ...
    context "when multiple students exist" do
      before do
        FactoryBot.create(:raid_statistics, raid: raid, defense_type: "light", student_uid: "10001", slots_count: 100)
        FactoryBot.create(:raid_statistics, raid: raid, defense_type: "light", student_uid: "10002", slots_count: 300)
        FactoryBot.create(:raid_statistics, raid: raid, defense_type: "light", student_uid: "10003", slots_count: 200)
      end
